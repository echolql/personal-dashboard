  ...
  if (isFrameless) {
    ...
    return (
      <div className="flex flex-col items-end text-right">
        ...
        <div className="flex items-center gap-2 text-xs font-medium text-slate-400 drop-shadow-md mt-1 tracking-wide">
          <span>{highF}° H</span>
          <span className="opacity-40">|</span>
          <span>{lowF}° L</span>
        </div>
        <span className="text-xs text-slate-400 mt-1">Bellevue, WA</span>
      </div>
    )
  }
